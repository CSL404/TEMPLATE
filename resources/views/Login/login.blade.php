@extends('Login.base')
@section('title') Nombre proyecto @endsection
@section('content')
<!-- begin login-content -->
<div class="login-content">
    <form method="POST" action="{{ route('login') }}" class="margin-bottom-0">
        ...
        <div class="form-group mb-1">
            <input data-toggle="password" data-placement="after" class="form-control form-control-lg @error('password') is-invalid @enderror" type="password"  name="password" placeholder="Contraseña" required />
            @error('password')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="login-buttons">
            <button type="submit" class="btn btn-info btn-block btn-lg">Ingresar <i class="fa fa-sign-in-alt"></i></button>
        </div>
