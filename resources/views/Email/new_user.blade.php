										...
										<tr>
											<td class="wrapper">
												...
												<table class="nine columns">
													<tr><h2><center><div class="titulo"> {{ config('app.name') }} </div></center></h2></tr>
												</table>
												<!-- end six columns -->
											</td>
										</tr>
							...
							<td>
									...
									<tr>
										...
										<td class="wrapper">
											<table class="twelve columns">
												<tr>
													<td class="last">
														<h6>Hola, se ha registrado un nuevo usuario.</h6>
													</td>
												</tr>
                                                <tr>
													<td class="m-t-15 last">
												...
												<tr>
													<td>
														<p class="m-t-15 last">
															<br><br>
															Puede ingresar al sistema dando clic en el siguiente enlace, para ver los detalles:
															<a href="{{ url('/') }}" class="btn btn-success"  target="_blank" >{{ config('app.name') }}</a>
														</p>
													</td>
												</tr>
											</table>
								...
								<table class="row">
									<tr>
										...
										<td class="wrapper">
											<p>
												<i>Este es un correo electrónico generado por el sistema y no se requiere respuesta.</i>
											</p>
										</td>
										<!-- end wrapper -->
									</tr>
